...
public class MavenApi {
    ...
    public PluginInfo resolvePlugin(Plugin plugin) {
        ...
        try {
            ...
            pluginInfo.getClassPath(JavaScopes.RUNTIME).add(new Artifact(pluginArtifact.getGroupId(),
            ...
            for(ArtifactResult result : dependencyResult.getArtifactResults()) {
                ...
                pluginInfo.getClassPath(JavaScopes.RUNTIME).add(new Artifact(a.getGroupId(), a.getArtifactId(), a.getVersion(), a.getFile()));
            }
            return pluginInfo;
