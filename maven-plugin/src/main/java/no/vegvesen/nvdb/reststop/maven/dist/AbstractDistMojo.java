...
package no.vegvesen.nvdb.reststop.maven.dist;
...
import no.vegvesen.nvdb.reststop.maven.AbstractReststopMojo;
import no.vegvesen.nvdb.reststop.maven.Plugin;
        ...
        if (plugins != null) {
            ...
            for (Plugin plugin : plugins) {
                ...
                if (plugin.getDependencies() != null) {
                    for (no.vegvesen.nvdb.reststop.maven.Dependency dependency : plugin.getDependencies()) {
